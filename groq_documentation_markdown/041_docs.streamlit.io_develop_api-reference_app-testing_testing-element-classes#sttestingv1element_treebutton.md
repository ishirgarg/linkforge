...
### Attributes
* `value`: The currently selected value as a hex string.
...
* `indices`: The indices of the currently selected values from the options.
* `value`: The currently selected values from the options.
* `values`: The currently selected values from the options.
