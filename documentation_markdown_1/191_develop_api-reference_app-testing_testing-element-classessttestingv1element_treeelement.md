...
*   `decrement`([`/develop/api-reference/app-testing/testing-element-classes#numberinputdecrement`](/develop/api-reference/app-testing/testing-element-classes#numberinputdecrement))
