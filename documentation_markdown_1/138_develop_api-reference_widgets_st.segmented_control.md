```markdown
# st.segmented_control - Streamlit

> **Source:** [https://docs.streamlit.io/develop/api-reference/widgets/st.segmented_control](https://docs.streamlit.io/develop/api-reference/widgets/st.segmented_control)
...
[`st.segmented_control`](https://github.com/streamlit/streamlit/blob/1.50.0/lib/streamlit/elements/widgets/button_group.py#L698 "View st.segmented_control source code on GitHub")
...
[Fullscreen _open\_in\_new_](https://doc-segmented-control-multi.streamlit.app//?utm_medium=oembed&)
...
[Fullscreen _open\_in\_new_](https://doc-segmented-control-single.streamlit.app//?utm_medium=oembed&)
