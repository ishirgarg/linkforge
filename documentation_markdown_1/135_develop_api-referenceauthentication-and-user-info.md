...
[Original URL](https://docs.streamlit.io/develop/api-reference#authentication-and-user-info)
...
st.image(np.random.rand(100, 100)) # numpy_array
st.image(open("my_image.png", "rb").read()) # image_bytes
st.image("my_image.png") # file
st.image("https://example.com/myimage.jpg") # URL
```
...
# Example usage with different input types
st.audio(np.random.rand(1000)) # numpy_array
st.audio(open("my_audio.wav", "rb").read()) # audio_bytes
st.audio("my_audio.wav") # file
st.audio("https://example.com/myaudio.mp3", format="audio/mp3") # URL
```
...
# Example usage with different input types
st.video(np.random.rand(100, 100)) # numpy_array
st.video(open("my_video.mp4", "rb").read()) # video_bytes
st.video("my_video.mp4") # file
st.video("https://example.com/myvideo.mp4", format="video/mp4") # URL
```
...
[The simplest way to handle a progress bar in streamlit app.](https://github.com/Wirg/stqdm) Created by [@Wirg](https://github.com/Wirg).
...
[A custom notification box with the ability to close it out.](https://github.com/Socvest/streamlit-custom-notification-box) Created by [@Socvest](https://github.com/Socvest).
