...
*   **Tags**
    ...
    [Add tags to your Streamlit apps. Created by @gagan3012.](https://github.com/gagan3012/streamlit-tags)
...
*   **NLU**
    ...
    [https://github.com/JohnSnowLabs/nlu](https://github.com/JohnSnowLabs/nlu)
...
#### [Log in a user](https://docs.streamlit.io/develop/api-reference/user/st.login)
`st.login()` starts an authentication flow with an identity provider.
```python
st.login()
```

#### [Log out a user](https://docs.streamlit.io/develop/api-reference/user/st.logout)
`st.logout()` removes a user's identity information.
```python
st.logout()
```

#### [User info](https://docs.streamlit.io/develop/api-reference/user/st.user)
...
#### [Page](https://docs.streamlit.io/develop/api-reference/navigation/st.page)
...
#### [Switch page](https://docs.streamlit.io/develop/api-reference/navigation/st.switch_page)
...
#### [Modal dialog](https://docs.streamlit.io/develop/api-reference/execution-flow/st.dialog)
Insert a modal dialog that can rerun independently from the rest of the script.
```python
@st.dialog("Sign up")
def email_form():
...
#### [Rerun script](https://docs.streamlit.io/develop/api-reference/execution-flow/st.rerun)
Rerun the script immediately.
```python
st.rerun()
```

#### [Stop execution](https://docs.streamlit.io/develop/api-reference/execution-flow/st.stop)
...
#### [Cache resource](https://docs.streamlit.io/develop/api-reference/caching-and-state/st.cache_resource)
...
#### [Query parameters](https://docs.streamlit.io/develop/api-reference/caching-and-state/st.query_params)
...
#### [Context](https://docs.streamlit.io/develop/api-reference/caching-and-state/st.context)
...
#### [Create a connection](https://docs.streamlit.io/develop/api-reference/connections/st.connection)
...
#### [Connection base class](https://docs.streamlit.io/develop/api-reference/connections/st.connections.baseconnection)
...
#### [Secrets singleton](https://docs.streamlit.io/develop/api-reference/connections/st.secrets)
Access secrets from a local TOML file.
```python
key = st.secrets["OpenAI_key"]
```

#### [Secrets file](https://docs.streamlit.io/develop/api-reference/connections/secrets.toml)
