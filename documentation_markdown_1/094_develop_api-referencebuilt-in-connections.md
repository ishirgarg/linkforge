...
> **Source:** [https://docs.streamlit.io/develop/api-reference#built-in-connections](https://docs.streamlit.io/develop/api-reference#built-in-connections)
...
#### [Static tables](https://docs.streamlit.io/develop/api-reference/data/st.table)
Display a static table.
```python
st.table(my_data_frame)
```

#### [Metrics](https://docs.streamlit.io/develop/api-reference/data/st.metric)
Display a metric in big bold font, with an optional indicator of how the metric changed.
```python
st.metric("My metric", 42, 2)
```

#### [Dicts and JSON](https://docs.streamlit.io/develop/api-reference/data/st.json)
