    ...
    try:
        ...
        for j, chunk in enumerate(chunks, 1):
            ...
            try:
                ...
                processed_chunks.append(response.message.content)
                print("✅")
...
def main():
    ...
    try:
        ...
        run_full_pipeline(
            documentation_url=documentation_url,
            crawl_result_filename="ollama_test_crawl_results.json",
            markdown_output_path="ollama_test_documentation_markdown",
            max_urls=max_urls,
